...
uint256 hashGenesisBlock("0xef9a6c6e62d18ff49f50647f8540f77a5eb0cacf0224cea1d0e777a9f909eaed");
...
const string strMessageMagic = "Cacaperro Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight == 7){
        nSubsidy = 1777777 * COIN;
    }

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Cacaperro: 1 day
static const int64 nTargetSpacing = 180; // Cacaperro: 3 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cacaperro miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Cacaperro", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x401e85b3c7323b163ac650530010201c4e371188ceb7960ec223374afd364251");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1497657225; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 5292681;

        if (fTestNet)
        {
            block.nTime    = 1497490758;
            block.nNonce   = 586544;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2dcbbc29f91a2303513501d79c112073a86ec548bf709d3ab18204eacdcf7f67"));
