...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        scrollAreaWidgetContents->setCACAmetry(QRect(0, 0, 666, 165));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 CACA", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
